...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Lado Direito - Informações (60%) */}
      <div className="w-3/5 bg-gradient-to-br from-emerald-600 via-emerald-500 to-emerald-700 flex items-center justify-center p-12 relative overflow-hidden">
        {/* Decoração de fundo */}
